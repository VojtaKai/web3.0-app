...
export const Navbar = () => {
    ...
    return (
        <>
            <nav className="flex md:justify-around justify-between">
                <ul className="flex flex-row w-full xl:w-8/12">
                ...
                {isToggled && (
                    ...
                    >
                        <li className="mx-4 mt-8 py-2 text-blue-700 font-medium flex-wrap">Check Markets</li>
                        <li className="mx-4 py-2 text-blue-700 font-medium flex-wrap">Add wallet</li>
                        <li className="mx-4 py-2 text-blue-700 font-medium flex-wrap">Visible wallets</li>
                        <li className="p-2 text-blue-700 font-bold flex-nowrap">
                            <button className="py-2 px-10 bg-blue-300 border-2 border-blue-800 rounded-3xl" onClick={onLogin}>
                                Login
                            </button>
                        </li>
