        ...
        <div>
            <div className='flex flex-col md:flex-row md:justify-between items-center px-10'>
                ...
                <ul className='flex flex-col md:flex-row md:justify-evenly items-center md:w-9/12 w-full flex-wrap'>
                    <li className="mx-8 py-2 text-blue-700 font-medium flex-wrap cursor-pointer">Check Markets</li>
                    <li className="mx-8 py-2 text-blue-700 font-medium flex-wrap cursor-pointer">Add wallet</li>
                    <li className="mx-8 py-2 text-blue-700 font-medium flex-wrap cursor-pointer">Visible wallets</li>
                </ul>
            </div>
